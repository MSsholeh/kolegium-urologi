        ...
        <div class="row">
                        ...
                        <div class="kt-sc__top">
                            <div class="kt-sc__content">
                                <h2 class="kt-sc__title">
                                    ...
                                    Portal PPDS Kolegium Urologi - Indonesia
                                </h2>
                            </div>
                        </div>
                    </div>
            ...
            @if($examPeriod)
                <div class="col-12 p-5 text-center">
                    <h3>Pengumuman Ujian<br/>{{ $examPeriod->name }} </h3>
                    <h5>{{ Daster::tanggal($examPeriod->started_at).' s/d ' . Daster::tanggal($examPeriod->ended_at) }}</h5>
                </div>
            ...
            <div class="col-12 p-5 text-center">
                <h3>Pengumuman Pendaftaran<br/>{{ $period->name }} </h3>
                <h5>{{ Daster::tanggal($period->started_at).' s/d ' . Daster::tanggal($period->ended_at) }}</h5>
            </div>
            ...
            <div class="col-md-6">
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        @if($university->registrant->count() === 0)
                            <p class="text-center">Belum ada pendaftar</p>
                        @endif
