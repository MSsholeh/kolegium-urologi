    ...
    <div class="kt-container  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" id="form-register" action="{{ route('web.schedule.course.store', $schedule->id) }}" enctype="multipart/form-data" method="POST">
    ...
    <script>
        $(function(){
            ...
            Daster.initValidate("#form-register", {
                rules: {},
                contentReload: '{{ route('web.schedule.course.submitted', $schedule->id) }}'
            });
