                        ...
                        <form class="kt-form kt-form--fit kt-margin-b-20 hidden" id="kt_filter" style="display: none;">
                            <div class="row kt-margin-b-20">
                                <div class="col-lg-6 kt-margin-b-10-tablet-and-mobile">
                                    ...
                                    <input type="text" class="form-control kt-input" placeholder="Nomor Sertifikat" data-col-index="1">
                                </div>
                                <div class="col-lg-6 kt-margin-b-10-tablet-and-mobile">
                                    <label>Nama</label>
                                    <input type="text" class="form-control kt-input" placeholder="Nama" data-col-index="3">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
