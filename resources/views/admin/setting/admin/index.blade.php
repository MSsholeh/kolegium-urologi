                    ...
                    <form class="kt-form kt-form--fit kt-margin-b-20 hidden" id="kt_filter" style="display: none;">
                        <div class="row kt-margin-b-20">
                            <div class="col-lg-6 kt-margin-b-10-tablet-and-mobile">
                                <label>Nama</label>
                                <input type="text" class="form-control kt-input" placeholder="Nama Admin" data-col-index="1">
                            </div>
                            <div class="col-lg-6 kt-margin-b-10-tablet-and-mobile">
                                <label>Email</label>
                                <input type="text" class="form-control kt-input" placeholder="Email" data-col-index="2">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
