                ...
                <div class="kt-section__content">
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" name="name" required class="form-control" placeholder="Nama" value="{{ $value->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-control-label">Alamat <span class="kt-font-danger">*</span> :</label>
                            <textarea name="location" class="form-control" required placeholder="Alamat Universitas">{{ $value->location }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
