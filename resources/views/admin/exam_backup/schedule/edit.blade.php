...
<div class="modal-body">
    <!--begin::Form-->
    <form action="{{ route($route.'.update', [$exam->id, $schedule->id]) }}" class="kt-form kt-form--label-right" id="form-modal"  method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <select name="period_id" class="form-control select2-period">
                                <option value="{{ $schedule->period_id }}">{{ $schedule->period->name.', '.$schedule->period->started_at.' s/d '.$schedule->period->ended_at }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="event_date" required class="form-control input-datepicker" value="{{ Daster::tanggal($schedule->event_date) }}" placeholder="Tanggal">
                        </div>
                        <div class="col-lg-6">
