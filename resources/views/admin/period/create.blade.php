                ...
                <div class="kt-section__content">
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" name="name" required class="form-control" placeholder="Nama periode">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-control-label">Tipe Periode <span class="kt-font-danger">*</span> :</label>
                            <select name="type" class="form-control select-select2">
                                <option value="registration" selected>Periode Registrasi</option>
