...
<div class="modal-body">
    <!--begin::Form-->
    <form action="{{ route($route.'.store', [$course->id, $schedule->id, $participant->id]) }}" class="kt-form kt-form--label-right" id="form-modal"  method="POST">
            ...
            <div class="kt-section">
                <div class="kt-section__content">
                    ...
                    @foreach($requirements as $requirement)
                        ...
                        @php($field = $requirement->requirement)
                    ...
                    <div class="form-group mt-4">
                        ...
                        <div class="kt-form__control">
                            <input data-switch="true" name="result" @if($participant->status === 'Diterima') checked @endif type="checkbox" data-on-text="Terima" data-handle-width="50" data-off-text="Tolak" data-on-color="success">
                        </div>
                    </div>
                </div>
            </div>
