        ...
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                    ...
                    <a href="{{ route($route.'.create', [$course->id, $schedule->id]) }}" class="btn btn-bold btn-twitter btn-sm btn-icon-h kt-margin-l-10 shoot-modal">
                        ...
                        <form class="kt-form kt-form--fit kt-margin-b-20 hidden" id="kt_filter" style="display: none;">
                            <div class="row kt-margin-b-20">
                                <div class="col-lg-12 kt-margin-b-10-tablet-and-mobile">
                                    ...
                                    <input type="text" class="form-control kt-input" placeholder="Judul materi" data-col-index="1">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
