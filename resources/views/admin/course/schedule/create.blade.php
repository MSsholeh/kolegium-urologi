...
<div class="modal-body">
    <!--begin::Form-->
    <form action="{{ route($route.'.store', $course->id) }}" class="kt-form kt-form--label-right" id="form-modal"  method="POST">
                ...
                <div class="kt-section__content">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="date" required class="form-control input-daterangepicker" placeholder="Tanggal kursus">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-control-label">Instruktur <span class="kt-font-danger">*</span> :</label>
                            <input type="text" name="convenor" required class="form-control" placeholder="Nama Instruktur">
                        </div>
                    </div>
