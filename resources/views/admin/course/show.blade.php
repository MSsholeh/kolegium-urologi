                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Jadwal Kursus</h3>
                        </div>
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-subheader__wrapper">
                                <button type="button" data-size="lg" class="btn btn-bold btn-danger btn-sm btn-icon-h kt-margin-l-10" aria-expanded="false" id="dt-trash">
                                    <i class="la la-trash"></i>
                                    <span>Sampah</span>
                                </button>
                                <button type="button" data-size="lg" class="btn btn-bold btn-secondary btn-sm btn-icon-h kt-margin-l-10" aria-expanded="false" id="l-toggle-filter">
                                    <i class="la la-search"></i>
                                    Filter
                                </button>
                                <a href="{{ route($route.'.schedule.create', $course->id) }}" class="btn btn-bold btn-twitter btn-sm btn-icon-h kt-margin-l-10 shoot-modal">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            Daster.initTable('#table-schedule', {
                url: '{{ route($route.'.schedule.table', $course->id) }}',
                columns: [
