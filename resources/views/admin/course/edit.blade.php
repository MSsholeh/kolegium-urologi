            ...
            <div class="kt-section">
                <div class="kt-section__content">
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-control-label">Nama Kursus<span class="kt-font-danger">*</span> :</label>
                            <input type="text" name="name" required class="form-control" placeholder="Nama kursus" value="{{ $value->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-control-label">Deskripsi <span class="kt-font-danger">*</span> :</label>
                            <textarea name="description" rows="3" placeholder="Deskripsi" class="form-control">{{ $value->description }}</textarea>
