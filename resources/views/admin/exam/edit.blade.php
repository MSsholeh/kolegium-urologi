                ...
                <div class="kt-section__content">
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <select name="period_id" class="select2-period">
                                <option value="{{ $value->period_id }}">{{ $value->period ? $value->period->name.', '.$value->period->started_at . ' s/d ' . $value->period->ended_at : '' }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" name="title" required class="form-control" placeholder="Judul Ujian" value="{{ $value->title }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
